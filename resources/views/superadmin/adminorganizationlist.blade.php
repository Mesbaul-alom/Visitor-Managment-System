    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Admin Assign</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form method="POST" action="{{url('/admin/organization/add')}}"   class="parsley-examples" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
           ...
           <div class="row">
               <div class="col-md-6">
                ...
                <select name="organization" id="organization" class="form-control" >
                    <option selected disabled>Select Orginization</option>
